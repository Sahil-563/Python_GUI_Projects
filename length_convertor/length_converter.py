...
msg = Label(app,text = "Enter the value:",background = "black",foreground = "yellow",font = ("bold",10) )
...
msg = Label(app,text = "Result: ",background = "black",foreground = "yellow",font = ("bold",10))
msg.grid(row = 3,column = 0,pady =15)
b = Button(app,text = "Convert",command = convert,relief = "raised",borderwidth=3,background = "black",foreground = "yellow")
